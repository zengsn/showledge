...
var essayJS = {
    ...
    //添加回复
    addReply: function(commentId, path) {
    	var userIdInSession = $("#userIdInSession").val();
    	if (userIdInSession == '') {
            location.href = path + "login";
            return true;
    ...
    //添加喜欢
    addFavourite: function(essayId, path) {
    	var userIdInSession = $("#userIdInSession").val();
        if (userIdInSession == '') {
            location.href = path + "login";
            return true;
        ...
        function(result) {
            if (result && result['success']) {
                ...
                $("#mid-favourite-button-a").attr("onclick", "essayJS.removeFavourite(" + essayId + "," + path + ")");
    ...
    //取消喜欢
    removeFavourite: function(essayId, path) {
    	var userIdInSession = $("#userIdInSession").val();
    	if (userIdInSession == '') {
            location.href = path + "login";
            return true;
        ...
        function(result) {
            if (result && result['success']) {
                ...
                $("#mid-favourite-button-a").attr("onclick", "essayJS.addFavourite(" + essayId + "," + path + ")");
