    ...
    Maleskine.Captcha = function (i) {
        function n() {
            ...
            n.__super__.constructor.apply(this, arguments), this.captchaType = this.el.data("captcha-type"), this.form = this.el.parents("form"), "geetest" === this.captchaType ? (i = {
                ...
                lang: "zh-cn",
                https: !1
            }, null != window.Geetest ? (t = new window.Geetest(i), t.appendTo("#geetest-area"), t.onSuccess(function (e) {
                return function () {
                    var i;
            ...
            }(this))) : (this.el.after("<a href='http://www.jianshu.com/p/3cb4c632dff0' target='_blank'><div class='load-error'><i class='fa fa-exclamation-triangle'></i> " + I18n.t("reading.captcha.geetest_not_loaded") + "</div></a>"), this.el.remove()), null != this.form && this.form.length > 0 && this.form.on("submit", function (e) {
                return function () {
