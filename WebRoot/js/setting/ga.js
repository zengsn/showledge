...
<head>
  <title>503 - Forwarding failure (Privoxy@DESKTOP-GAN5H7C)</title>
  ...
  <table summary="" cellpadding="20" cellspacing="10" border="0" width="100%">
    <tr>
      ...
      <td class="title" style="width: 100%">
        ...
        <h1>
          This is <a href="http://www.ccav1.me/chromegae">ChromeGAE-Privoxy</a> 3.0.24 on DESKTOP-GAN5H7C (127.0.0.1)<!-- @if-can-toggle-start -->,
    ...
    <tr>
      <td class="warning" colspan=2>
        <h2>Forwarding failure</h2>
          <p>Privoxy was unable to <b>socks5-forward</b> your request
             <a  title="Repeat the request"
              href="http://www.google-analytics.com/ga.js"><b>http://www.google-analytics.com/ga.js</b></a>
             through <b>127.0.0.1</b>:
            <strong>socks5 server unreachable</strong></p>
          </p>
          <p>Just <a title="Repeat the request" href="http://www.google-analytics.com/ga.js">try again</a> to
        ...
        <ul>
          ...
          <li>
            read the <a title="Contacting the developers, Bug Reporting and Feature Requests"
             href="http://www.privoxy.org/3.0.24/user-manual/contact.html">instructions in the User Manual</a>
