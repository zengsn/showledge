              ...
              <div class="span3">
                <ul class="nav nav-list">
                  <li id="essay_li" data-type="notes" class="active">
                    <a href="javascript:void(0)" onclick="searchEssay('<%=path%>/');">文章</a></li>
                  <li id="corpus_li" data-type="notebooks" class="">
                    <a href="javascript:void(0)" onclick="searchCorpus('<%=path%>/');">文集</a></li>
                  <li id="user_li" data-type="users" class="">
                    <a href="javascript:void(0)" onclick="searchUser('<%=path%>/');">作者</a></li>
                </ul>
              </div>
              <div class="span7">
                    ...
                    <c:forEach items="${essayList}" var="essay" varStatus="status">
                      <li>
                        ...
                        <div class="list-footer">
                          ...
                          <span>${essay.subEssayTime}</span></div>
                      </li>
                    </c:forEach>
                  </ul>
