<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <html>
      ...
      <body class="output fluid zh cn win reader-day-mode reader-font2 " data-js-module="" data-locale="zh-CN" id="my-vueJS">
        <c:if test="${userNameInSession == null}">
          <div class="wrap-btn">
            <div class="article-related pull-left">
              ...
              <a class="notebooks-menu-btn" data-toggle="modal" data-target="#notebooks-menu" href="javascript:void(null);">
            ...
            <div class="span3">
              <ul class="nav nav-list">
                <li id="essay_li" data-type="notes" class="active">
                  <a href="javascript:void(0)" onclick="searchEssay();">文章</a></li>
                <li id="corpus_li" data-type="notebooks" class="">
                  <a href="javascript:void(0)" onclick="searchCorpus();">文集</a></li>
                <li id="user_li" data-type="users" class="">
                  <a href="javascript:void(0)" onclick="searchUser();">作者</a></li>
              </ul>
            </div>
            <div class="span7">
              <div class="page-title clearfix">
                <div class="input-prepend pull-right">
                  <form>
                    <div class="btn-group">
                      <button id="choose_button_content" class="btn dropdown-toggle" data-toggle="dropdown" type="button">文章
                        <span class="caret"></span></button>
                      <ul class="dropdown-menu">
                        <li id="choose_essay_li" data-type="notes" style="display: none;">
                          <a href="javascript:void(0)" onclick="showEssayButton()">文章</a></li>
                        <li id="choose_corpus_li" data-type="notebooks">
                          <a href="javascript:void(0)" onclick="showCorpusButton()">文集</a></li>
                        <li id="choose_user_li" data-type="users">
                          <a href="javascript:void(0)" onclick="showUserButton()">作者</a></li>
                      </ul>
                    </div>
                    <input id="hideSearchKeyword" type="hidden" value="${searchKeyword}">
                    <input id="searchKeyword" name="searchKeyword" type="search" placeholder="搜索" class="input-medium" onkeypress="if(event.keyCode==13) {search();return false;}">
              ...
              <div class="search-results-container">
                <ul id="search_ul" class="unstyled list">
                  <c:forEach items="${essayList}" var="essay" varStatus="status">
                    <li>
                      <h4 class="title">
                        <a href="essay.html?id=${essay.id}" target="_blank">
                          <i class="fa fa-file-text"></i>${essay.essayTitle}</a>
                      </h4>
                      <p>${essay.essayContent}</p>
                      <div class="list-footer">
                        <a href="">${essay.userName}</a>
                        <a href="">· 阅读 ${essay.essayReadingNumber}</a>
                        <a href="">· 评论 ${essay.essayCommentNumber}</a>
                        <span>· 喜欢${essay.essayGoodNumber}</span>·
                        <span data-timeago="" title="2015-05-17T03:57:08.000Z">大约1年之前</span></div>
                    </li>
                  </c:forEach>
                </ul>
                ...
                Next
                <li data-page="2"><a href="javascript:void(null)">下一页</a></li></ul>
                </div> -->
              </div>
            </div>
          </div>
