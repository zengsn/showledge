      ...
      <div id="share-modal" class="modal fade share-directly-modal fullscreen in">
        ...
        <div class="container">
          <div class="modal-header">
            <h3 class="">
              <i class="fa fa-check"></i>随记发布成功！</h3>
          </div>
              ...
              <ul class="share unstyled">
                <li class="item-1 share-link">
                  ...
                  <div class="arrow-top dropdown-menu permlink" href="">
                    ...
                    <a href="javascript:void(null)" class="btn btn-info btn-small copy-to-clipboard" data-clipboard-target="permlink-text">复制链接</a></div>
                </li>
                <li class="weibo">
                ...
                <li class="weixin share-wechat">
                  ...
                  <div class="arrow-top dropdown-menu" title="">
                    ...
                    <img style="display: block;" src=""></div>
                </li>
                <li class="ellipsis">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(null)">
                  ...
                  <ul class="dropdown-menu arrow-top more-sns">
                    <li>
                      <a href="" data-sns="tweibo">
                        <img src="img/post_success/tweibo.png">分享到腾讯微博</a></li>
                    <li>
                      <a href="" data-sns="qzone">
                        <img src="img/post_success/qzone.png">分享到QQ空间</a></li>
                    <li>
                      <a href="" data-sns="twitter">
                        <img src="img/post_success/twitter.png">分享到Twitter</a></li>
                    <li>
                      <a href="" data-sns="facebook">
                        <img src="img/post_success/facebook.png">分享到Facebook</a></li>
                    <li>
                      <a href="" data-sns="google_plus">
                        <img src="img/post_success/google_plus.png">分享到Google+</a></li>
                  </ul>
                </li>
              </ul>
            </div>
