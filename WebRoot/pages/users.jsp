		...
		<div class="user-aside span3">
			<div class="people">
				<div class="basic-info">
					...
					<h3>
						<a href="users.html?userName=${user.userName}">${user.userName}</a>
					</h3>
					<div class="btn-group" id="follow_mail_block_user_1534944">
						<div class="btn btn-small btn-success follow"
							id="follow_user_1534944">
							<a data-type="json" data-user-slug="73df7acb979a"
								data-remote="true" rel="nofollow" data-method="post" href=""><i
								class="fa fa-plus"></i> <span>添加关注</span></a>
						</div>

						<a class="btn btn-small btn-list btn-success"
							data-toggle="dropdown" href="javascript:void(0)"><i
							class="fa fa-bars"></i></a>
						<ul class="dropdown-menu arrow-top" role="menu"
							aria-labelledby="dLabel">
							<li><a href="writer.html"><i
									class="fa fa-fw fa-envelope"></i> 写简信</a></li>
							<li class="divider"></li>
							<li><a id="block_user_1534944" data-remote="true"
								rel="nofollow" data-method="post" href=""><i
									class="fa fa-fw fa-lock"></i> 加入黑名单</a></li>
							<li class="dropdown-submenu" data-js-module="report"><a
								href="javascript:void(0)"><i class="fa fa-fw fa-flag-o"></i>
									举报用户</a>
								<ul class="dropdown-menu">
									<li><a data-type="json" data-remote="true" rel="nofollow"
										data-method="post" href="">广告或垃圾信息</a></li>
									<li><a data-type="json" data-remote="true" rel="nofollow"
										data-method="post" href="">抄袭或未授权转载</a></li>
									<li><a data-toggle="modal" href="">其他</a></li>
								</ul></li>
				...
				<div id="list-container" class="tab-pane active">
					<ul class="article-list latest-notes">
						<c:forEach items="${essayList}" var="essay">
							<li class="have-img">
								<%-- <a class="wrap-img"
								href="users.html?userName=${essay.userName}"><img
									src="${user.userImagePath}" alt="300"></a> --%>
								<div>
									<p class="list-top">
										<a class="author-name blue-link" target="_blank"
											href="users.html?userName=${essay.userName}">${essay.userName}</a>
					...
					<div class="hidden">
						<div class="pagination">
							<ul class="pagination">
								<li class=" active"><a data-remote="true"
									href="javascript:null;">1</a></li>
								<li class=""><a rel="next" data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=2">2</a>
								</li>
								<li class=""><a data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=3">3</a>
								</li>
								<li class=""><a data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=4">4</a>
								</li>
								<li class=""><a data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=5">5</a>
								</li>
								<li class="next"><a rel="next" data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=2">下一页</a>
								</li>
								<li class="last"><a data-remote="true"
									href="http://www.jianshu.com/users/73df7acb979a/latest_articles?page=10">终页</a>
								</li>
							</ul>
						</div>
					</div>
