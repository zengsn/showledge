...
public class WriterController {
	...
	public String initWriter(Model model, HttpSession session) {
		if (session.getAttribute("userIdInSession") != null) {
			...
			List<Corpus> corpusList = corpusService.getCorpusByUserId(userIdInSession);
	 ...
	 * @return
	 */
	@RequestMapping(value="/writer/addNote.do",method=RequestMethod.POST)
	public @ResponseBody  AjaxResult<Object> addNote(String title,String content,String type){
		essayService.addNote(title,content,type);
	...
	public String updatenode(Model model,int essayId) {
		//获取所有的类型
		List<EssayType> select = essayTypeService.select(null);
		model.addAttribute("essaytype", select);
	 ...
	 * @return
	 */
	@RequestMapping(value="/writer/doUpdateNode.do",method=RequestMethod.POST)
	public @ResponseBody  AjaxResult<Object> doUpdateNode(int essayid,String title,String content,String type){
		essayService.updateNote(essayid,title,content,type);
	...
	@RequestMapping("/writer/deleteEssay")
	public @ResponseBody AjaxResult<Object> deleteComent(Integer essayId){
		essayService.deleteEssayById(essayId);
