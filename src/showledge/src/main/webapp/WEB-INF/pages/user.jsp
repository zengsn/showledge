        ...
        <div class="col-md-10 main">
          <div class="row">
            ...
            <div class="col-md-3 user-profile">
              <a href="#" class="user-name">${sessionScope.user.userName}</a>              <p class="user-summary">${sessionScope.user.userInfo.introduction}</p>
              <div id="user-address"><span class="fa fa-map-marker fa-fw"></span>${sessionScope.user.userInfo.location}</div>
              <div id="user-graduation"><span class="fa fa-graduation-cap fa-fw"></span>${sessionScope.user.userInfo.academy}</div>
              <div id="user-join-date"><span class="fa fa-calendar fa-fw"></span>加入于 <span>${sessionScope.user.userFormatCreateTime}</span></div>
